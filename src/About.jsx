    ...
    <div className='h-auto min-h-screen overflow-x-hidden w-full'>
      <div className='flex flex-col justify-center items-center p-6 sm:p-12 bg-gray-800 shadow-2xl transition-all duration-300 hover:shadow-4xl'>
        <div className='text-center'>
          <h1 className='text-4xl sm:text-6xl font-extrabold text-white mb-6'>About Me</h1>
          <p className='text-lg sm:text-2xl text-gray-300 leading-relaxed w-full sm:w-3/4 mx-auto'>
        ...
        <h1 className='text-4xl sm:text-6xl font-bold text-white text-center pt-6 sm:pt-10 mt-10'>My Skills</h1>
